...
public class Controller {
    ...
    public static void transferFund(Integer loginId){
        System.out.print("Enter the wallet Id to which amount needs to be transferred: ");
...
//                registerId = numScan.nextInt();
                ...
                while (true) {
                    ...
                    if (isValid) {
                        Integer loginInput;
                        System.out.println("Please select action               wallet ID: "+loginId);
                        System.out.println("1 - Show wallet balance\n2 - Add fund\n3 - withdraw fund\n4 - Transfer fund to another account\n5 - Delete wallet\n6 - back");
